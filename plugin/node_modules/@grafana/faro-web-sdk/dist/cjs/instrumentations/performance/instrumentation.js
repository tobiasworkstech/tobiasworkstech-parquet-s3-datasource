...
var PerformanceInstrumentation = /** @class */ (function (_super) {
    __extends(PerformanceInstrumentation, _super);
    function PerformanceInstrumentation() {
        var _this = _super !== null && _super.apply(this, arguments) || this;
        _this.name = '@grafana/faro-web-sdk:instrumentation-performance';
        _this.version = faro_core_1.VERSION;
        return _this;
    }
    PerformanceInstrumentation.prototype.initialize = function () {
        var _this = this;
        ...
        (0, performanceUtils_1.onDocumentReady)(function () { return __awaiter(_this, void 0, void 0, function () {
            var pushEvent, faroNavigationId;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        pushEvent = this.api.pushEvent;
                        return [4 /*yield*/, (0, navigation_1.getNavigationTimings)(pushEvent)];
                    case 1:
                        faroNavigationId = (_a.sent()).faroNavigationId;
