...
function createV1Theme(theme) {
  ...
  const basicColors = __spreadProps(__spreadValues({}, commonColorsPalette), {
    black: "#000000",
    white: "#ffffff",
    dark1: "#141414",
    dark2: "#161719",
  ...
  return __spreadProps(__spreadValues({}, oldCommon), {
    type: theme.colors.mode === "dark" ? GrafanaThemeType.Dark : GrafanaThemeType.Light,
    isDark: theme.isDark,
    isLight: theme.isLight,
    name: theme.name,
    palette: __spreadProps(__spreadValues({}, basicColors), {
    ...
    colors: __spreadProps(__spreadValues(__spreadValues(__spreadValues(__spreadValues({}, backgrounds), borders), form), textColors), {
