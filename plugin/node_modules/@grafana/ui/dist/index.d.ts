...
type Props$1h<T> = NoticeProps<SelectableValue<T>, boolean, GroupBase<SelectableValue<T>>>;
...
declare class PopoverController extends Component<Props$1g, State$7> {
    private hideTimeout;
    state: {
        show: boolean;
    };
...
interface Props$1f extends InputHTMLAttributes<HTMLInputElement> {
    label: string;
...
interface Props$1e extends Omit<InputHTMLAttributes<HTMLInputElement>, 'onReset'> {
...
interface Props$1d extends React__default.HTMLProps<HTMLInputElement> {
...
declare class Input$1 extends PureComponent<Props$1d, State$6> {
    static defaultProps: {
        className: string;
    };
    state: State$6;
...
declare class Switch$1 extends PureComponent<Props$1c, State$5> {
    state: {
        id: string;
    };
...
type Props$1b = BasePropsWithTooltip | BasePropsWithAriaLabel;
declare const IconButton: React__default.ForwardRefExoticComponent<Props$1b & React__default.RefAttributes<HTMLButtonElement>>;
...
interface Props$1a extends HTMLAttributes<HTMLDivElement> {
    className?: string;
}
declare const ButtonGroup: React__default.ForwardRefExoticComponent<Props$1a & React__default.RefAttributes<HTMLDivElement>>;
...
declare const DeleteButton: ({ size, disabled, onConfirm, "aria-label": ariaLabel, closeOnConfirm }: Props$19) => React__default.JSX.Element;

type RenderPopperArrowFn = (props: {
    arrowProps: PopperArrowProps;
    placement: string;
}) => JSX.Element;
interface Props$18 extends Omit<React__default.HTMLAttributes<HTMLDivElement>, 'content'> {
    show: boolean;
    placement?: Placement$1;
    content: PopoverContent;
...
declare class Popover extends PureComponent<Props$18> {
    render(): React__default.JSX.Element;
}
...
declare function Portal(props: PropsWithChildren<Props$17>): React__default.ReactPortal;
/** @internal */
...
interface Props$15 extends ButtonProps {
...
declare function ClipboardButton({ onClipboardCopy, onClipboardError, children, getText, icon, variant, ...buttonProps }: Props$15): React__default.JSX.Element;
...
interface Props$14 extends Omit<HTMLProps<HTMLInputElement>, 'prefix' | 'size'> {
    /** Sets the width to a multiple of 8px. Should only be used with inline forms. Setting width of the container is preferred in other cases.*/
    width?: number;
...
declare const Input: React__default.ForwardRefExoticComponent<Omit<Props$14, "ref"> & React__default.RefAttributes<HTMLInputElement>>;
...
interface ColorPickerInputProps extends Omit<Props$14, 'value' | 'onChange'> {
    value?: string;
...
declare const EmptySearchResult: ({ children }: Props$13) => React__default.JSX.Element;
...
declare const ToolbarButtonRow: React__default.ForwardRefExoticComponent<Props$11 & React__default.RefAttributes<HTMLDivElement>>;
...
declare const TimeOfDayPicker: ({ minuteStep, showHour, showSeconds, onChange, value, size, disabled, disabledHours, disabledMinutes, disabledSeconds, }: Props$$) => React__default.JSX.Element;
...
declare const TimeZonePicker: (props: Props$_) => React__default.JSX.Element;
...
declare const WeekStartPicker: (props: Props$Z) => React__default.JSX.Element;
...
/** @public */
interface DatePickerWithInputProps extends Omit<Props$14, 'ref' | 'value' | 'onChange'> {
...
declare const DateTimePicker: ({ date, maxDate, minDate, label, onChange, disabledHours, disabledMinutes, disabledSeconds, showSeconds, }: Props$Y) => React__default.JSX.Element;
...
interface Props$X<TableData extends object> {
    className?: string;
    /**
...
/** @alpha */
declare function InteractiveTable<TableData extends object>({ className, columns, data, getRowId, headerTooltips, pageSize, renderExpandedRow, fetchData, }: Props$X<TableData>): React__default.JSX.Element;
...
declare const TagsInput: ({ placeholder, tags, onChange, width, className, disabled, addOnBlur, invalid, id, }: Props$W) => React__default.JSX.Element;
...
declare function AutoSaveField<T = string>(props: Props$V<T>): React__default.JSX.Element;
...
declare const Pagination: ({ currentPage, numberOfPages, onNavigate, hideWhenSinglePage, showSmallVersion, className, }: Props$U) => React__default.JSX.Element | null;
...
declare const TagList: React__default.NamedExoticComponent<Props$S & React__default.RefAttributes<HTMLUListElement>> & {
    readonly type: React__default.ForwardRefExoticComponent<Props$S & React__default.RefAttributes<HTMLUListElement>>;
} & {
    Skeleton: (props: unknown) => React__default.JSX.Element;
};
...
declare function Modal(props: PropsWithChildren<Props$R>): React__default.JSX.Element | null;
...
/** @internal */
declare const ModalHeader: ({ icon, iconTooltip, title, children, id }: React__default.PropsWithChildren<Props$Q>) => React__default.JSX.Element;
...
declare const ModalTabsHeader: ({ icon, title, tabs, activeTab, onChangeTab }: Props$P) => React__default.JSX.Element;
...
/** @internal */
declare const ModalTabContent: ({ children }: React__default.PropsWithChildren<Props$O>) => React__default.JSX.Element;
...
/** @alpha */
declare const PageToolbar: React__default.MemoExoticComponent<({ title, section, parent, pageIcon, onGoBack, children, titleHref, parentHref, leftItems, isFullscreen, className, "aria-label": ariaLabel, buttonOverflowAlignment, forceShowLeftItems, }: Props$N) => React__default.JSX.Element>;
...
declare const Table: React__default.MemoExoticComponent<(props: Props$L) => React__default.JSX.Element>;
...
declare const TabContent: ({ children, className, ...restProps }: Props$J) => React__default.JSX.Element;
...
declare const VizLegendListItem: {
    <T = unknown>({ item, onLabelClick, onLabelMouseOver, onLabelMouseOut, className, readonly, }: Props$E<T>): React__default.JSX.Element;
    displayName: string;
};
...
declare const ControlledCollapse: ({ isOpen, onToggle, ...otherProps }: React__default.PropsWithChildren<Props$C>) => React__default.JSX.Element;
declare const Collapse: {
    ({ isOpen, label, loading, collapsible, onToggle, className, children, }: React__default.PropsWithChildren<Props$C>): React__default.JSX.Element;
    displayName: string;
};
...
declare const CollapsableSection: ({ label, isOpen, onToggle, className, contentClassName, children, labelId, loading, headerDataTestId, contentDataTestId, }: Props$B) => React__default.JSX.Element;
 ...
 * @internal
 */
declare function FieldLinkList({ links }: Props$A): React__default.JSX.Element;

interface Props$z {
    className?: string;
}
declare const FullWidthButtonContainer: ({ className, children }: React__default.PropsWithChildren<Props$z>) => React__default.JSX.Element;
...
declare class ClickOutsideWrapper extends PureComponent<React__default.PropsWithChildren<Props$y>, State$2> {
    static defaultProps: {
        includeButtonPress: boolean;
...
interface Props$x extends React__default.HTMLAttributes<HTMLDivElement> {
    color?: string;
    gradient?: string;
}
declare const SeriesIcon: React__default.MemoExoticComponent<React__default.ForwardRefExoticComponent<Props$x & React__default.RefAttributes<HTMLDivElement>>>;
...
declare const ErrorWithStack: {
    ({ error, errorInfo, title }: Props$u): React__default.JSX.Element;
    displayName: string;
};
...
declare const CertificationKey: ({ hasCert, label, onChange, onClick, placeholder }: Props$q) => React__default.JSX.Element;
 ...
 * @public
 */
declare const Spinner: ({ className, inline, iconClassName, style, size, }: Props$p | PropsWithDeprecatedSize) => React__default.JSX.Element;
...
declare function FadeTransition(props: Props$o): React__default.JSX.Element;
...
declare function SlideOutTransition(props: Props$n): React__default.JSX.Element;
...
/** @internal */
declare function SegmentSelect<T>({ value, placeholder, options, onChange, onClickOutside, loadOptions, width: widthPixels, noOptionsMessage, allowCustomValue, allowEmptyValue, ...rest }: React__default.PropsWithChildren<Props$m<T>>): React__default.JSX.Element;
...
declare function Drawer({ children, onClose, closeOnMaskClick, scrollableContent, title, subtitle, width, size, tabs, }: Props$l): React__default.JSX.Element;
 ...
 * @alpha
 */
declare const Link: React__default.ForwardRefExoticComponent<Props$k & React__default.RefAttributes<HTMLAnchorElement>>;
...
interface Props$j extends Omit<HTMLProps<HTMLFieldSetElement>, 'label'> {
    children: React__default.ReactNode[] | React__default.ReactNode;
    /** Label for the fieldset's legend */
    label?: React__default.ReactNode;
}
declare const FieldSet: ({ label, children, className, ...rest }: Props$j) => React__default.JSX.Element;
...
interface Props$i extends Omit<FieldProps, 'css' | 'horizontal' | 'description' | 'error'> {
...
declare const InlineField: {
    ({ children, label, tooltip, labelWidth, invalid, loading, disabled, required, className, htmlFor, grow, shrink, error, transparent, interactive, ...htmlProps }: Props$i): React__default.JSX.Element;
    displayName: string;
};
...
declare const InlineSegmentGroup: {
    ({ children, className, grow, ...htmlProps }: React__default.PropsWithChildren<Props$h>): React__default.JSX.Element;
    displayName: string;
};

interface Props$g extends Omit<LabelProps$1, 'css' | 'description' | 'category'> {
...
declare const InlineLabel: ({ children, className, tooltip, width, transparent, interactive, as: Component, ...rest }: Props$g) => React__default.JSX.Element;

interface Props$f extends Omit<HTMLProps<HTMLDivElement>, 'css'> {
    children: ReactNode | ReactNode[];
}
declare const InlineFieldRow: ({ children, className, ...htmlProps }: Props$f) => React__default.JSX.Element;
...
interface Props$e extends Props$14 {
...
declare const AutoSizeInput: React__default.ForwardRefExoticComponent<Omit<Props$e, "ref"> & React__default.RefAttributes<HTMLInputElement>>;

interface Props$d extends Omit<HTMLProps<HTMLInputElement>, 'onChange'> {
    value: string | undefined;
    width?: number;
    onChange: (value: string) => void;
    escapeRegex?: boolean;
}
declare const FilterInput: React__default.ForwardRefExoticComponent<Omit<Props$d, "ref"> & React__default.RefAttributes<HTMLInputElement>>;

type Props$c = React$1.ComponentProps<typeof Input> & {
...
declare const SecretInput: ({ isConfigured, onReset, ...props }: Props$c) => React$1.JSX.Element;

interface Props$b extends Omit<HTMLProps<HTMLTextAreaElement>, 'size'> {
    /** Show an invalid state around the input */
    invalid?: boolean;
}
declare const TextArea: React__default.ForwardRefExoticComponent<Omit<Props$b, "ref"> & React__default.RefAttributes<HTMLTextAreaElement>>;

type Props$a = React$1.ComponentProps<typeof TextArea> & {
    /** TRUE if the secret was already configured. (It is needed as often the backend doesn't send back the actual secret, only the information that it was configured) */
    isConfigured: boolean;
    /** Called when the user clicks on the "Reset" button in order to clear the secret */
    onReset: () => void;
 ...
 */
declare const SecretTextArea: ({ isConfigured, onReset, ...props }: Props$a) => React$1.JSX.Element;

interface Props$9 extends Omit<HTMLProps<HTMLInputElement>, 'value'> {
    value?: boolean;
...
declare const Switch: React__default.ForwardRefExoticComponent<Omit<Props$9, "ref"> & React__default.RefAttributes<HTMLInputElement>>;
interface InlineSwitchProps extends Props$9 {
    showLabel?: boolean;
}
...
declare const FileUpload: ({ onFileUpload, className, children, accept, size, showFileName, }: React__default.PropsWithChildren<Props$8>) => React__default.JSX.Element;
 ...
 * @public
 */
interface Props$7 extends Omit<CardContainerProps, 'disableEvents' | 'disableHover'> {
...
interface CardInterface extends FC<Props$7> {
...
interface Props$6 extends Omit<HTMLProps<HTMLDivElement>, 'className' | 'value' | 'style'> {
    value: FormattedValue;
    className?: string;
    style?: CSSProperties;
}
declare const FormattedValueDisplay: {
    ({ value, className, style, ...htmlProps }: Props$6): React__default.JSX.Element;
    displayName: string;
};

interface Props$5<T> extends HTMLAttributes<HTMLButtonElement> {
    className?: string;
    options: Array<SelectableValue<T>>;
    value?: SelectableValue<T>;
    onChange: (item: SelectableValue<T>) => void;
...
declare const ButtonSelect: {
    <T>(props: Props$5<T>): React__default.JSX.Element;
    displayName: string;
};
...
declare const Dropdown: React__default.MemoExoticComponent<({ children, overlay, placement, offset, onVisibleChange }: Props$4) => React__default.JSX.Element>;
...
declare const InlineFormLabel: ({ children, isFocused, isInvalid, className, htmlFor, tooltip, width, interactive, ...rest }: Props$3) => React__default.JSX.Element;
...
interface Props$2 {
    ...
    primaryPaneStyles?: React__default.CSSProperties;
    secondaryPaneStyles?: React__default.CSSProperties;
    /**
 ...
 * @alpha
 */
declare function Splitter(props: Props$2): React__default.JSX.Element;
...
declare const LegacyForms: {
    SecretFormField: {
        ({ label, labelWidth, inputWidth, onReset, isConfigured, tooltip, placeholder, interactive, ...inputProps }: Props$1e): React$1.JSX.Element;
        displayName: string;
    };
    FormField: {
        ({ label, tooltip, labelWidth, inputWidth, inputEl, className, interactive, ...inputProps }: Props$1f): React$1.JSX.Element;
        displayName: string;
        defaultProps: {
            labelWidth: number;
            inputWidth: number;
    ...
    NoOptionsMessage: <T extends unknown>(props: Props$1h<T>) => React$1.JSX.Element;
